...
export function TokenSelect({
  ...
  return (
    <span className={cn("relative block w-full", className)}>
      <select
        className="h-auto w-full appearance-none rounded-8 border-fig border-border bg-surface-primary py-1.5 pl-2 pr-6 font-geist text-fig-caption-1 text-heading-03 shadow-field"
        {...props}
      />
